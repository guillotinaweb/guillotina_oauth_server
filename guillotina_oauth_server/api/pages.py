...
from guillotina_oauth_server.flow.csrf import OAUTH_CSRF_FIELD, csrf_token
from guillotina_oauth_server.flow.scopes import OAUTH_SCOPE_DESCRIPTIONS


TEMPLATE_DIR = Path(__file__).parent / "templates"
BRAND_LOGO_PATH = Path(__file__).parent / "static" / "guillotina-logo-horizontal.svg"
