...
from guillotina_oauth_server.api.endpoints.common import AUTHORIZATION_REQUEST_SINGLETON_PARAMS
from guillotina_oauth_server.api.pages import consent_form, login_form, oauth_error_page
from guillotina_oauth_server.auth.helpers import authenticate_user_credentials
from guillotina_oauth_server.flow.clients import (
    redirect_uri_registered_for_client,
    redirect_with_params,
    scopes_registered_for_client,
)
from guillotina_oauth_server.flow.consent import build_consent_key
from guillotina_oauth_server.flow.csrf import OAUTH_CSRF_FIELD, csrf_valid
from guillotina_oauth_server.flow.pkce import pkce_challenge_valid
from guillotina_oauth_server.flow.scopes import OAUTH_DEFAULT_SCOPE, oauth_scopes_supported
from guillotina_oauth_server.flow.tokens import generate_opaque_token
from guillotina_oauth_server.indicators.grant import validate_resource_indicator
from guillotina_oauth_server.utils.ratelimit import rate_limit_check, rate_limit_exceeded
from guillotina_oauth_server.utils.request import (
    normalize_list,
