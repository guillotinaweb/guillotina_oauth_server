...
from guillotina_oauth_server.api.endpoints.common import REVOCATION_REQUEST_SINGLETON_PARAMS
...
from guillotina_oauth_server.utils.request import form_content_type_valid, parse_form_encoded, peer_ip_address
