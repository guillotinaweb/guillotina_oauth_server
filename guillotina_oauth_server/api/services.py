...
import guillotina_oauth_server.discovery  # noqa — triggers well-known handler registrations
from guillotina_oauth_server.api.endpoints.authorize import authorization_endpoint
from guillotina_oauth_server.api.endpoints.common import OAuthService
from guillotina_oauth_server.api.endpoints.consents import list_consents_endpoint, revoke_consent_endpoint
from guillotina_oauth_server.api.endpoints.register import client_registration_endpoint
from guillotina_oauth_server.api.endpoints.revoke import token_revocation_endpoint
from guillotina_oauth_server.api.endpoints.token import token_endpoint
from guillotina_oauth_server.discovery.routing import WELL_KNOWN_HANDLERS, serve_well_known_metadata
