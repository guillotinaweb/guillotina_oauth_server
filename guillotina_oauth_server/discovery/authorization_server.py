...
from guillotina_oauth_server.discovery.routing import register_well_known_handler
from guillotina_oauth_server.flow.scopes import oauth_scopes_supported
