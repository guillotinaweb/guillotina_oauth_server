...
def reset_oauth_integration_registries():
    from guillotina_oauth_server.discovery.protected_resource import reset_protected_resource_providers
    from guillotina_oauth_server.indicators.registry import reset_indicator_registries
...
OAUTH_MCP_SETTINGS: dict[str, Any] = {
    "applications": ["guillotina", "guillotina_oauth_server", "guillotina.contrib.mcp"],
    "oauth": {"registration_rate_limit": 0, "token_rate_limit": 0, "revoke_rate_limit": 0},
    "auth_extractors": [
        "guillotina.auth.extractors.BearerAuthPolicy",
        "guillotina.auth.extractors.BasicAuthPolicy",
