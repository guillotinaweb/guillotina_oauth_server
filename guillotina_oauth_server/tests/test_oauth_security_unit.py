...
from guillotina_oauth_server.utils.ratelimit import rate_limit_check, rate_limit_exceeded, reset_rate_limits
from guillotina_oauth_server.utils.urls import container_issuer_url, validate_issuer


@pytest.mark.asyncio
@pytest.mark.app_settings({"applications": ["guillotina", "guillotina_oauth_server"]})
...
@pytest.mark.asyncio
@pytest.mark.app_settings(
    {"applications": ["guillotina", "guillotina_oauth_server", "guillotina.contrib.redis"], "redis": {}}
)
async def test_oauth_rate_limit_uses_redis_when_configured(monkeypatch, dummy_guillotina):
    from guillotina_oauth_server.utils import ratelimit
